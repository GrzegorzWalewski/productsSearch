    ...
    <div class="grid grid-cols-2 p-4">
        <h2 class="text-xl font-semibold text-black dark:text-white my-auto">Products</h2>
            ...
            <div class="relative">
                ...
                <input type="search" wire:keydown="beforeSearch" wire:model.live="search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search by name or manufacturer" />
            </div>
    </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody x-data="{ expanded: @entangle('expanded') }">
                ...
                <tr wire:key="{{ $product->id }}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <tr wire:key="{{ $product->id }}">
                    <td :class="expanded=={{$product->id}} ? '' : 'hidden'" colspan="7">
                        <div>
                            <livewire:product-details wire:key="{{ $product->id }}" :product="$product" />
                        </div>
                    </td>
                </tr>
                @endforeach
